...
/**
 * XYChartInfo provides information about areas in an {@link XYChart}. Most of
 * the methods deal with locating components of the chart in the coordinate
 * space of the reference node. The reference node could be the chart itself or
 * an ancestor of the chart.
 * <p/>
 * There is a current limitation of this class in that there must not be scaling
 * or rotation transformations between the reference node and the chart's axes.
 * Therefore, the reference node is best when it is the chart itself or an
...
public class XYChartInfo {
    ...
    /**
     * Constructs the XYChartInfo to find chart information in the reference
    ...
    /**
     * Constructs the XYChartInfo to find chart information in the chart's
     * coordinate system.
     */
